 ...
 */
class ItemTouchHelperCallback(var mAdapter: PlaylistAdapter) : ItemTouchHelper.Callback() {
    val ALPHA_FULL = 1.0f


    override fun getMovementFlags(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder): Int {
        return ItemTouchHelper.Callback.makeMovementFlags(ItemTouchHelper.UP or ItemTouchHelper.DOWN,
